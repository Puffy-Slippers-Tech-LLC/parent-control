...
| --- | ---: | --- |
| Unit, property and contract | <span style="color: green">11463</span>/<span style="color: gray">0</span>/11463 | Checks isolated logic, invariants, interfaces and test-harness behavior. |
...
| Integration qualification | <span style="color: green">35</span>/<span style="color: gray">0</span>/35 | Checks installed-runner prerequisites, safety guards and integration building blocks. |
...
| **Total** | **<span style="color: green">12038</span>/<span style="color: gray">235</span>/12273** | All test cases across the categories above, including pending E2E scenarios. |
