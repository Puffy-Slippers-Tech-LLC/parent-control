...
_install-product-files:
	...
	install -m 0644 README.md LICENSE COPYRIGHT NOTICE docs/Compliance.md docs/System-Design.md docs/Package-Update.md docs/Package-Removal.md docs/Publishing.md docs/Data-Migration.md docs/parent-control-feedback.md docs/malcontent014-integration.md "$(DESTDIR)$(DATADIR)/doc/oh-no-parent-control/"
