...
def render(document, counts, *, root=ROOT):
    ...
    lines = [
        ...
        *[f'| {title} | {count_cell(ready, pending)} | {unit} |'
          for title, ready, pending, unit in rows],
        f'| **Total** | **{count_cell(ready_total, pending_total)}** | All entries above, including pending E2E |',
        '',
