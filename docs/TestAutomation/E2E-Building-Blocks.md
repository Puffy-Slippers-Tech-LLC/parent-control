...
Private collection, reconciliation and owned cleanup passed in that run (now outside runner retention). Complete case 6 then passed in the [retained regression report](Evidence/test-all-runs/20260923T193956Z-9e1b6eac/report.md), including the specific denial, management exclusion, desktop return, collection and owned cleanup.
