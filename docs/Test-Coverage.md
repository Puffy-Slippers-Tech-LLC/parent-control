...
| --- | ---: | --- |
| Unit, property and contract | <span style="color: green">11419</span>/<span style="color: gray">0</span>/11419 | Checks isolated logic, invariants, interfaces and test-harness behavior. |
...
| Integration qualification | <span style="color: green">33</span>/<span style="color: gray">0</span>/33 | Checks installed-runner prerequisites, safety guards and integration building blocks. |
...
| **Total** | **<span style="color: green">11992</span>/<span style="color: gray">235</span>/12227** | All test cases across the categories above, including pending E2E scenarios. |
