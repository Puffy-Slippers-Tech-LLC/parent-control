...
Private collection, reconciliation and owned cleanup passed. The [run report](Evidence/test-all-runs/20260923T193211Z-9824fb0f/report.md)
records this capability slice. Complete case 6 then passed in the [retained regression report](Evidence/test-all-runs/20260923T193956Z-9e1b6eac/report.md), including the specific denial, management exclusion, desktop return, collection and owned cleanup.
