...
| --- | ---: | --- |
| Unit, property and contract | <span style="color: green">11174</span>/<span style="color: gray">0</span>/11174 | Checks isolated logic, invariants, interfaces and test-harness behavior. |
...
| Integration qualification | <span style="color: green">28</span>/<span style="color: gray">0</span>/28 | Checks installed-runner prerequisites, safety guards and integration building blocks. |
...
| **Total** | **<span style="color: green">11743</span>/<span style="color: gray">235</span>/11978** | All test cases across the categories above, including pending E2E scenarios. |
