...
Consumer: E2E-026/process (136). Scope: LIFE04's matching update profile and LIFE05's process/none activation route.

Required implemented capabilities: LIFE01, LIFE04(update foundation), FLOW15/FLOW01 retained entry, FLOW03 and overlay choices/exits. Use maintained callables and an independent public entry state, never an earlier task document or attempt.
