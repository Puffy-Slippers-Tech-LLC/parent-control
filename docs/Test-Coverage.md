...
| --- | ---: | --- |
| Unit, property and contract | <span style="color: green">12554</span>/<span style="color: gray">0</span>/12554 | Checks isolated logic, invariants, interfaces and test-harness behavior. |
...
| Integration qualification | <span style="color: green">49</span>/<span style="color: gray">0</span>/49 | Checks installed-runner prerequisites, safety guards and integration building blocks. |
...
| **Total** | **<span style="color: green">13152</span>/<span style="color: gray">231</span>/13383** | All test cases across the categories above, including pending E2E scenarios. |
