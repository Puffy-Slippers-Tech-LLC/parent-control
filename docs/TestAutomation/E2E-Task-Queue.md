...
| [ ] | 029 | [Open feedback and read synthetic drafts](E2E-Tasks/029-feedback-read.md) | Baseline | FEED01, FEED03. Blocker: app-snapshot preparation fails two unrelated `write-e2e` cleanup prerequisites (`20260925T002355Z-61aea90d`, duration text mismatch); resume when launcher expectations and implementation are reconciled and prerequisites pass. | 20–30 |
