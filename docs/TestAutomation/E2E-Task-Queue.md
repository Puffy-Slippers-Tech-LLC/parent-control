...
| [x] | 003d | Log out through the shared system harness | 003ba, 003c | DESK04 direct logout, ended source session and usable GDM; separate restored switch assertion, private collection and owned cleanup passed | 20–30 |
| [x] | 001sa | Read the product's Shell search results | 003ba, 003c, 003d | SEARCH01/02/03/04/06 fresh Parent empty/first-character/full product query, launcher identity/focus and wrong-result refusal; Escape → observed empty field → Super → observed dismissal, private collection and owned cleanup passed in run `20260923T180845Z-4df4db55`; no launch or complete-scenario credit | 20–30 |
| [x] | 001sb | Launch Parent through administrator search | 001sa | SEARCH05 administrator launch through `onpc_parent::open_from_app_grid` and independently supplied `launch_search_result` entry; owned Parent window, UI18 normal close/desktop return, wrong-entry refusal, private collection and owned cleanup passed in run `20260923T182610Z-718ecc45`; no complete-scenario credit | 20–30 |
| [x] | 003r | Requalify retained case 3 | 001sb | Retained regression 3; complete existing/new-child discovery in one retained Parent window, declared FIX01 checkpoint, immutable settings comparisons, private evidence reconciliation and owned cleanup passed in run `20260923T183522Z-d4969e1e`; coverage regenerated | 20–30 |
| [x] | 004r | Requalify retained case 4 | 001sb | Retained regression 4; `parent_discovery.EMPTY_PLAN` and `onpc_parent_discovery::run_none` qualified the full no-child discovery, FIX02 checkpoint and public Parent empty result; collection and owned cleanup passed in run `20260923T184507Z-a2d36b98`; coverage regenerated | 20–30 |
| [x] | 001s | Prove Parent is unavailable to a standard account | 003ba, 003c, 003d, 001sb | SEARCH01–06 Parent launchable and standard-account unavailable bindings; `check_e2e_shell_search` qualified administrator launch/close and independent standard-account exact query, web suggestion and stable launcher/window absence, with private collection, reconciliation and owned cleanup in run `20260923T191129Z-64de2a7a`; no complete-scenario credit | 20–30 |
| [x] | 005r | Requalify retained case 5 | 001s | Retained regression 5; `parent_access.PLAN` and `onpc_parent_access::run` passed fresh standard login, exact app-grid query, web suggestion and stable Parent launcher/window absence, with private collection, reconciliation and owned cleanup in run `20260923T192157Z-7d86e72a`; coverage regenerated | 20–30 |
| [x] | 001t | Read direct-command management denial | 001s | PARENT01 standard-account direct command, specific public management denial, management exclusion and desktop return qualified through `check_e2e_terminal_provider`, with wrong-entry refusal, private collection and owned cleanup in run `20260923T193211Z-9824fb0f`; no complete-scenario credit | 20–30 |
| [x] | 002r | Requalify retained case 6 | 001t | Retained regression 6; `parent_terminal.PLAN` and `onpc_parent_terminal::run` reused PARENT01 direct command, observed the specific denial and management exclusion, then dismissed it and independently observed the standard desktop; collection and owned cleanup passed in run `20260923T193956Z-9e1b6eac`; coverage regenerated | 20–30 |
| [x] | 235r | Requalify retained case 193 | 001t | Retained regression 193; `command_help.PLAN` and `onpc_command_help::run` read both installed help commands and manuals through bounded guarded SSH stdout, independently verified the clear desktop after each, and passed collection and owned cleanup in run `20260923T194553Z-e2f16f7e`; coverage regenerated | 20–30 |
| [x] | 185l | Qualify the installed license viewer | 001s | ABOUT02/03 Parent/GNOME Text Editor identity/content and close/return qualified through `check_e2e_license_viewer`, including independent entry, unrelated/empty document refusal, ambiguous-window/close refusal, unchanged Parent settings, private collection and owned cleanup in run `20260923T201618Z-50520052`; no complete-scenario credit | 20–30 |
| [x] | 151r | Requalify retained case 151 | 185l | Retained regression 151; `parent_about.PLAN` and `onpc_parent_about::run` passed complete About/license/return, unchanged child/settings, reconciliation, collection and owned cleanup in run `20260923T202401Z-9e9a5886`; coverage regenerated. Shared migration gate closed using the developer's confirmed separate passes for all seven ready cases and explicit direction against further reruns | 20–30 |
| [x] | 012b | Select eligible kiosk children and approvers | 011, 017, 003d | REQUEST04 `AccessibleUI.select_kiosk_account` qualified exact eligible child/approver sets, public selection and independent enabled-form readback through `check_e2e_kiosk_eligible_choices`; Parent saved preparation, Switch User, wrong-entry/choice refusals, collection and owned cleanup passed in run `20260923T204614Z-0601b77a`; no complete-scenario credit | 20–30 |
| [x] | 012 | Read kiosk disabled-child availability | 011, 017, 003d, 012b | REQUEST04 disabled-child selection and REQUEST08 exact explanation/unavailable Request qualified through `check_e2e_request_choices` in run `20260923T235007Z-9d21bba1`: separate public Parent disable/save, Switch User, exact eligible child set, independent readback, no prompt, wrong-entry/choice refusals, collection and owned cleanup passed. Retains 012b's unchanged enabled-branch evidence; no complete-scenario credit. | 20–30 |
| [x] | 018 | E2E-017: disabled-child | 012, 013 | Cases 57; passed in run `20260924T001910Z-3076f596`: limits remained off, exact child choices inspected/collapsed, disabled child selected, unavailable Request/explanation and no prompt observed, Cancel returned to GDM; reconciliation, collection, owned cleanup and baseline restoration passed. Coverage regenerated. | 20–30 |
| [x] | 024b | Prepare and qualify the no-child kiosk profile | 012 | FIX03 no-child profile and public station empty state qualified through `check_e2e_kiosk_no_child` in run `20260924T064646Z-19f2aad6`: fixed child-only fixture, independent station entry, wrong-entry refusal, exact empty child set/explanation, disabled Request, no prompt, sanitized collection, owned cleanup and baseline restoration passed. No complete-scenario credit. | 20–30 |
| [x] | 026 | E2E-017: no-child | 024b, 013 | Cases 54; complete live acceptance passed in run `20260924T152534Z-98108590`: exact empty child set/explanation, unavailable Request, no prompt, Cancel to GDM, evidence reconciliation, collection, owned cleanup and baseline restoration. | 20–30 |
| [x] | 024 | Prepare the no-approver kiosk profile | 012, 024b | FIX03 no-approver profile qualified through `check_e2e_kiosk_fixtures` in run `20260924T173358Z-94d5db62`: public nonempty parent baseline, discovery/locking of all eligible parents without fixed names/counts, Cancel/GDM return, fresh station entry and repeated exact empty-parent explanation/unavailable-control/no-prompt checks passed. Shared station navigation's no-child regression passed in run `20260924T173643Z-8d742069`. Both attempts passed collection, owned cleanup and baseline restoration. Complete case 55 and multiple/ineligible profiles remain pending. | 20–30 |
| [x] | 026b | E2E-017: no-parent | 024, 013 | Cases 55; passed independently through `kiosk_no_approver.CASE_PLAN` / `onpc_no_parent::run` in run `20260924T175340Z-dd93d54f`: public nonempty-parent baseline, discovered eligible-parent locking, Cancel/GDM return, fresh station entry, exact empty-parent explanation/list, disabled submission and absent prompt. Capture reconciliation, collection, owned cleanup and baseline restoration passed; coverage regenerated. | 20–30 |
| [x] | 004a | Give repeated public operations distinct stages | Baseline | JourneyPlan repeated invocation IDs and durable assertion placement; fresh Parent entry, wrong-child refusal, two immutable-baseline page returns, collection, reconciliation and owned cleanup passed | 30–50 (exception) |
| [x] | 004 | Allow distinct single-use authentication challenges | 003d, 004a | UI19/GDM05 distinct Parent GDM challenges; wrong-recipient refusal, two independent desktop results, shared DESK04 logout, durable assertions, reconciliation, private collection and owned cleanup passed in run `20260924T192200Z-c833e973`; no complete-scenario credit | 40–60 (exception) |
| [x] | 005a | Start a graphical journey before product installation | 001t, 004 | Product-free Parent entry, two fresh recipient proofs, greeter command-context refusal, administrator authority and verified package digest qualified through `check_e2e_product_free_entry` in run `20260924T203125Z-f94d7c37`; actual provider tuples, capture reconciliation, private collection, owned cleanup and baseline restoration passed; no complete-scenario credit | 30–50 (exception) |
| [x] | 005 | Qualify the shared package command boundary | 005a | AUTH03 and FILE01/02/06 fixed `install-staged-package` authority, wrong-command/artifact/VM/attempt/replay refusals and independent successful completion/final reboot notice qualified through `check_e2e_package_authority` in run `20260924T215601Z-8f5800a9`; private collection, capture reconciliation, owned cleanup and baseline restoration passed; LIFE04 composition and complete-case acceptance remain pending | 20–30 |
| [x] | 006 | Perform a customer package operation | 005 | LIFE04 install qualified through `check_e2e_package_command` in run `20260924T221715Z-9ebb5329`: fresh product-free entry, greeter refusal, administrator authority, one verified package submission and independent completion/final reboot notice passed with private collection, capture reconciliation, owned cleanup and baseline restoration. Other package operations and complete case 2 remain pending. | 20–30 |
| [x] | 007 | Observe a deliberate customer reboot | 006 | LIFE02 fresh install/reboot/administrator return qualified through `check_e2e_customer_reboot` in run `20260924T223309Z-4d98a4b2`: one guarded planned reboot, changed boot, fresh usable GDM and administrator desktop passed with wrong-entry refusal, private collection, capture reconciliation, owned cleanup and baseline restoration. Unexpected boot changes still refuse; complete case 2 belongs to task 008. | 40–60 (exception) |
| [x] | 077a | Read app rows and initial access choices | Baseline | PARENT12; UI13 complete bounded public app-row observations qualified through `check_e2e_app_row_observations` in run `20260924T232402Z-75f99b74`: 46 initial Allowed rows, identical independent App Limits reread, wrong-child/page refusals, private collection, owned cleanup and baseline restoration passed. Complete case 2 belongs to task 008. | 20–30 |
| [x] | 008 | E2E-002: clean | 007, 013, 077a | Cases 2; passed in `20260924T234059Z-27bb3ecf`: fresh installation/final notice, real reboot, preserved personal accounts/station, limits-off/zero/Allowed defaults and station Cancel. Shared Parent-launch case 6 passed in `20260924T234847Z-41112953`; both passed collection, owned cleanup and baseline restoration. Coverage refreshed after each. | 40–60 (exception) |
| [x] | 029 | Open feedback and read synthetic drafts | Baseline | FEED01 ordinary Parent entry and FEED03 initial-empty projection qualified by `check_e2e_feedback_read` in run `20260925T011124Z-21d4f936`: independent reopen, wrong-entry refusal, collection and owned cleanup passed; Send untouched. Other feedback bindings remain pending. | 20–30 |
| [x] | 009 | Replace a nonsecret field value | 029 | UI16 Parent feedback body/reply replacement twice and clear qualified by `check_e2e_text` in run `20260925T030015Z-4c7d9b02`: exact independent readback, independent reopen, wrong/disabled-target refusal, collection and owned cleanup passed; Send untouched. Other text bindings and complete feedback scenarios remain pending. | 20–30 |
| [x] | 040b | Select and read ordinary daily presets | 009, 017 | PARENT05 preset 0/15 selection qualified by `check_e2e_allowance_presets` in run `20260925T044650Z-53e3ca11`: fresh entry, independent saved and reopened-selected readback, wrong-child and disabled-control refusal, collection, owned cleanup and baseline restoration passed. Custom values and complete scenarios remain pending. | 20–30 |
| [x] | 040 | Commit custom daily allowances | 009, 017, 040b | PARENT05/06 ordinary custom 1/pause, 2/Enter and 3/Tab qualified by `check_e2e_allowance` in run `20260925T053812Z-45e24883`: preset 0/15 regressions, independent saved and child-reloaded editor readback, wrong-child and disabled-control refusal, collection, owned cleanup and baseline restoration passed. Boundary values and complete scenarios remain pending. | 20–30 |
| [x] | 194 | Read an expanded time explanation | 040 | PARENT20 qualified by `check_e2e_read_an_expanded_time_explanation` in run `20260925T061535Z-18f56b25`: saved ordinary allowance, explicit expansion preparation, collapsed/wrong-child refusal, two read-only daily/one-time/total projections with one-second precision and increasing monotonic observation times, collection, owned cleanup and baseline restoration passed. PARENT09 and complete scenarios remain separate. | 20–30 |
| [x] | 041 | Read remaining time and configure time controls | 194 | PARENT09 and FLOW02's 0/15-minute preset scope qualified by `check_e2e_time_explanation` in run `20260925T062949Z-49d65b22`: conditional expansion, repeated non-collapsing reads, conditional enable, explicit final enablement, saved settings, positive/zero balances with one-second precision, wrong-entry refusal, retained PARENT20 checks, collection, owned cleanup and baseline restoration passed. Custom-value composition and complete scenarios remain separate. | 20–30 |
| [x] | 180 | Set an allowance for a named child | 041 | FLOW01 fresh/same-user new-window entry and FLOW16 fresh-zero/same-user-15-minute setup qualified by `check_e2e_set_an_allowance_for_a_named_child` in `20260925T064318Z-ac40f2a1`: explicit parent/child/entry, saved settings, zero/positive balances, independent rereads, wrong-child/window refusal, collection, owned cleanup and baseline restoration passed. Affected case 6 passed in `20260925T064705Z-37ca73c8`; coverage regenerated. Other bindings and complete case 161 remain separate. | 15–30 |
| [x] | 203 | E2E-036: zero-total | 180 | Cases 161; passed independently in `20260925T065641Z-c6d3948b`: fresh-zero FLOW16 setup, idle disabled Revoke with limits on/off, zero balances and saved zero allowance retained; public observations, collection, owned cleanup and baseline restoration passed. Coverage regenerated. | 20–30 |
| [x] | 028 | Close and reopen Parent | Baseline | LIFE01 Parent→management qualified by `check_e2e_app_restart` in report `20260925T070959Z-faca1de4`: explicit prior window/destination, active-window guard, normal closure, complete absence, shared direct relaunch, initial selection before edits, already-closed/wrong named-window refusal, collection, owned cleanup and baseline restoration passed. Other app bindings and complete cases remain separate. | 20–30 |
| [x] | 040a | Qualify daily-allowance boundaries | 040 | PARENT06 accepted custom 0/1/15/1439 and PARENT08 rejection of empty/abc/-1/0.5/1440/1441 qualified by `check_e2e_allowance_boundaries` in run `20260925T181548Z-2eeb40fa`. Every invalid input starts from saved 15 and independently reads unchanged saved/reopened-editor values. Preset 0/15 and custom 1/pause, 2/Enter, 3/Tab regressions, fresh entry, wrong-child/disabled refusal, collection, owned cleanup and baseline restoration passed with the authorized Parent repairs. All-preset enumeration and complete case 158 remain separate. | 20–30 |
| [x] | 200 | E2E-035: boundaries | 180, 040a, 028 | Complete case 158 passed in `20260926T031042Z-c0e70792`: all 50 presets, accepted custom 0/1/15/1439, all six rejected inputs from saved 15, both children's values after Parent reopening, guarded Parent continuous-activity preparation, collection, owned cleanup and baseline restoration. Coverage regenerated; case 159 remains separate. | 30–55 (exception) |
| [x] | 012c | Choose valid kiosk durations and soft-app access | 012, 009 | REQUEST04/05/06/08 kiosk 5-minute preset, exact custom 1.25 minutes, Rest of the day, independent estimates and soft-app inclusion/exclusion qualified by `kiosk_valid_duration.PLAN` / `check_e2e_kiosk_valid_duration` in run `20260926T043102Z-88f3a4f2`. Public Parent preparation, wrong-entry/choice refusals, no authentication, Cancel-to-GDM, collection, owned cleanup and baseline restoration passed; no complete-scenario credit. | 20–30 |
| [x] | 012a | Reject invalid kiosk durations | 012, 009, 012c | `request_duration.PLAN` / `check_e2e_request_duration` qualified REQUEST05/09 kiosk empty, abc, -1, 0, 0.09, 1440.1 and comma-decimal input in run `20260926T044605Z-b5be87de`: otherwise enabled Request, exact validation, preserved form and no authentication. Repeated REQUEST04/05/06/08 valid controls/estimates/soft-app regression, wrong-entry refusal, Cancel-to-GDM, collection, owned cleanup and baseline restoration passed; no complete-scenario credit. | 20–30 |
| [x] | 014 | Compose prepared request choices | 012a, 013 | FLOW04 kiosk `request_flow.prepared_request` / `onpc_request_flow::prepare`: explicit child/approver, custom 1.25 minutes and soft apps included. Independently open and fresh GDM entry, public balance/estimate comparison, reproduced choices, wrong-entry refusal and both Cancel returns passed `check_e2e_request_flow` in run `20260926T050310Z-aef4320a`, with collection, owned cleanup and baseline restoration; no complete-scenario credit. | 20–30 |
| [x] | 015 | E2E-015: kiosk-cancel | 180, 014 | Complete case 47 passed in `20260926T051531Z-576edf40`: independent Parent enablement/15-minute balance, explicit kiosk child/approver, custom 1.25 minutes with soft apps included, bounded estimate, one Cancel, absent form and usable GDM. Product, infrastructure, collection, owned cleanup and baseline restoration passed; coverage regenerated. | 20–30 |
| [x] | 015b | E2E-015: kiosk-escape | 180, 014 | Complete case 48 passed in `20260926T052659Z-8144eb94`: independent Parent enablement/15-minute balance, explicit kiosk child/approver, custom 1.25 minutes with soft apps included, bounded estimate, one guarded Escape, absent form and usable GDM. Product, infrastructure, collection, owned cleanup and baseline restoration passed; coverage regenerated. Shared Cancel/Escape regression `check_e2e_request_exit` passed in `20260926T053454Z-d3ce9eca`, including collection, owned cleanup and baseline restoration. | 20–30 |
| [x] | 019a | Inspect and qualify the kiosk MATE prompt entry | 012a, 004, 013 | `mate_prompt.PLAN` / `check_e2e_mate_prompt` qualified service ownership, selected administrator, displayed child/75-second/soft-app context and guarded Cancel in run `20260926T062624Z-b8f93cd2`. Two independent entries, unchanged usable no-error form return, Parent wrong-entry and projected wrong-agent/owner/ambiguous-field/replacement refusals, collection, owned cleanup and baseline restoration passed after the broker dismissal repair. No password submission or complete-scenario credit. | 20–30 |
| [x] | 019 | Qualify the real selected-parent approval prompt | 012a, 004, 019a | `mate_prompt.PLAN` / `check_e2e_auth_prompt` qualified fixed kiosk REQUEST09/AUTH01 in run `20260926T064045Z-b4159145`: two independent requests, displayed parent/child/75-second/soft-app context, empty masked focused field, same-challenge recheck, refusal matrix, one Cancel each and unchanged usable no-error form return. Invalid `abc` submission produced validation without authentication; unavailable entry retained disabled Request. Collection, owned cleanup and baseline restoration passed. No password submission or complete-scenario credit. | 20–30 |
| [x] | 020a | Qualify kiosk secret submission and automatic approved exit | 019, 013 | `kiosk_approval.PLAN` / `check_e2e_kiosk_approval` qualified fixed kiosk AUTH02 correct-password delivery and REQUEST11/12 explicit success/automatic GDM return in `20260926T065928Z-8c15b645`. Two fresh same-challenge recipient proofs, one secret delivery/submission, independent entry and refusal matrix, sealed private capture reconciliation, collection, owned cleanup and baseline restoration passed. No complete-scenario credit; rejection and immediate approved exit remain pending. | 20–30 |
| [x] | 020b | Observe kiosk password rejection and Cancel | 019, 013, 020a | `kiosk_rejection.PLAN` / `check_e2e_kiosk_rejection` qualified fixed AUTH02 wrong-password rejection/Cancel and separate password-free Cancel with REQUEST11 independently preserved usable form/choices in report run `20260926T154532Z-4ed66f34`. Same-challenge single-use delivery, independent entry/refusals, private collection, owned cleanup and baseline restoration passed. No complete-scenario credit. | 20–30 |
| [x] | 020 | Qualify immediate approved kiosk exit | 019, 013, 020a, 020b | `auth_result.PLAN` / `check_e2e_auth_result` qualified explicit success, one owned-ID immediate exit and independent GDM return in report run `20260926T160110Z-c946f822`; automatic exit regression passed `20260926T160801Z-2f278af9`. Both passed independent entry/refusals, private collection, owned cleanup and baseline restoration. Together with unchanged rejection/Cancel qualification `20260926T154532Z-4ed66f34`, delivers fixed kiosk AUTH02 and REQUEST11/12 outcome set; no complete-scenario credit. | 20–30 |
| [x] | 021a | Compose successful kiosk approval and time request | 020, 014 | Fixed kiosk FLOW05/06 `kiosk_approved_flow.approved_request` / `obtain_time` and `onpc_request_flow::approve` / `obtain_time` qualified by `check_e2e_kiosk_approved_flow` in `20260926T162146Z-b021e65a`: independent prepared entry/refusals, reproduced 75-second soft-included choices, explicit approval and automatic GDM return, private collection, owned cleanup and baseline restoration passed; no complete-scenario credit. | 20–30 |
| [x] | 022 | E2E-016: approved | 180, 021a | Case 50 passed independently in `20260926T172007Z-3a5d2feb`: fresh-zero Parent setup, all three station shortcut restrictions, exact 75-second soft-included request, real approval, explicit success and automatic usable-GDM return; private capture reconciliation, collection, owned cleanup and baseline restoration passed. Coverage regenerated. Denied/cancelled cases and About/report restrictions remain separate. | 20–30 |
| [x] | 021 | Compose kiosk rejection and cancellation | 020, 014, 021a | Fixed kiosk FLOW07 `approval_flow.rejected_request` / `onpc_request_flow::reject` passed separate rejection and Cancel attempts in `20260926T175707Z-78d5f0fd`: independent preserved-form comparison followed by a deliberately new FLOW05 challenge, explicit approval and automatic GDM return. FLOW05/06 regression passed `20260926T180713Z-246238d4`; both qualifications passed collection, owned cleanup and baseline restoration. No complete-scenario credit. | 20–30 |
| [x] | 023 | E2E-016: denied | 180, 021 | Case 51 passed in `20260926T183413Z-1058d7dc`: real rejection, preserved choices, repeated station restrictions and Cancel to usable GDM. Affected case 50 passed in `20260926T183900Z-53757cd3`; both passed collection, owned cleanup and baseline restoration. Coverage regenerated after each case. | 20–30 |
