# 185oa — Read overlay About and its license
...
Deliver **ABOUT01/02 overlay information and license-handler binding**. Named consumer: task **185o** and any
...
Reuse owned About IDs and the qualified document adapter, validating the actual child-session handler afresh. Bind license open/content/close and unchanged form return.
...
On a live overlay, capture choices, read product/version, open the actual license and read its identifying contents. Close the viewer and About and compare unchanged choices; wrong handler/document refuses.
