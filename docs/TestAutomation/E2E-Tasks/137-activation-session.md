...
Consumer: E2E-026/session (137). Scope: LIFE04's matching update profile and LIFE05's session activation route.

Required implemented capabilities: LIFE04(update foundation), DESK03/04, GDM07, DESK08, FLOW15/FLOW01 retained entry, FLOW03 and overlay choices/exits. Use maintained callables and an independent public entry state, never an earlier task document or attempt.
