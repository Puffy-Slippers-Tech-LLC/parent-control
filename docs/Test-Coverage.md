...
| --- | ---: | --- |
| Unit, property and contract | <span style="color: green">11433</span>/<span style="color: gray">0</span>/11433 | Checks isolated logic, invariants, interfaces and test-harness behavior. |
...
| Integration qualification | <span style="color: green">34</span>/<span style="color: gray">0</span>/34 | Checks installed-runner prerequisites, safety guards and integration building blocks. |
...
| **Total** | **<span style="color: green">12007</span>/<span style="color: gray">235</span>/12242** | All test cases across the categories above, including pending E2E scenarios. |
