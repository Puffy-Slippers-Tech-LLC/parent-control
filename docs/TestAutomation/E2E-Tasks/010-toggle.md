...
Deliver **UI17**. First scheduled consumer: [E2E-017, case 57](../E2E-Scenario-Recipes.md#e2e-017).
...
Check **010** in the [master's queue](../E2E-Task-Queue.md), update the master's
