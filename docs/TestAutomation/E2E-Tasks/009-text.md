...
Deliver **UI16**. First scheduled consumer: [E2E-036, case 161](../E2E-Scenario-Recipes.md#e2e-036).
Read the named [block contracts](../E2E-Building-Blocks.md#public-observations-and-individual-inputs) and only the selected consumer's recipe.
...
```sh
tools/run-tests integration check_e2e_text
```
...
Check **009** in the [master's queue](../E2E-Task-Queue.md), update the master's
